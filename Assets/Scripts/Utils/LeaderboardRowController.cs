...
namespace Nucleo.UI
{
    public class LeaderboardRowController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Anima a entrada da linha (fade + slide lateral). Chamado pelo
        /// NarrativeUIController logo após o Instantiate, com delay escalonado
        /// por índice pra dar efeito de "lista descendo em cascata".
        /// </summary>
